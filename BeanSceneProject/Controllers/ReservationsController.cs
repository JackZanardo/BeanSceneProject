...
namespace BeanSceneProject.Controllers
{
    public class ReservationsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Start,CustomerNum,Duration,Notes,ReservationStatus,ReservationOriginId,SittingId,PersonId")] Reservation reservation)
        {
